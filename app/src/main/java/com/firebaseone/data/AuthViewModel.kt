...
import com.firebaseone.model.User
import com.firebaseone.naavigation.ROUTE_HOME
import com.firebaseone.naavigation.ROUTE_LOGIN
import com.firebaseone.naavigation.ROUTE_REGISTER
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase
//
//class AuthViewModel(var navHosController: NavHostController, var context:Context) {
//
...
//
//                        if (it.isSuccessful) {
//                            Toast.makeText(context, "Registerded Successfuly", Toast.LENGTH_LONG)
//                                .show()
...
//    progress.show()
//
//    mAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListner {
//        progress.dismiss()
//
//        if (it.isSuccesful) {
